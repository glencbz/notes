...
Since we haven't yet jumped into making models, we're going to focus mostly on routes today. But by the end of the week, you'll have a complete Sinatra application that you built yourself, including all the code that goes inside the controller actions we build today.
...
## Combining Verbs & Resources = RESTful Controller - Codealong
